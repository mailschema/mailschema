...
| Sourcey                     | `3.6.7` published and pinned                             | Sourcey remains the generic specification renderer. No stateful action service is added without an existing Sourcey product workflow.                                                                                                         |
