...
| Ruby                        | `0.2.0` prepared for MAP 0.2                  | To be published from [`mailschema/ruby`](https://github.com/mailschema/ruby) through RubyGems trusted publishing; Nitrosend's Content Review 0.3 implementation is built on it and deploys with the cutover                       |
...
| Nitrosend Node SDK          | `0.11.0` prepared                             | [`nitrosend/node-sdk#11`](https://github.com/nitrosend/node-sdk/pull/11) carried the MAP 0.1 field; `0.11.0` carries the MAP 0.2 contract and publishes with the cutover                                                          |
...
- The Node SDK `0.11.0` carries the MAP 0.2 transactional contract.
